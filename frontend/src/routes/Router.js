...
const MobileProctor = Loadable(lazy(() => import('../views/student/MobileProctor')));
//Auth Routes
...
const Router = createBrowserRouter(
  createRoutesFromElements(
    ...
    <>
      ...
      {/* Mobile Proctor (Public Route) */}
      <Route path="/mobile-proctor/:sessionId" element={<BlankLayout />}>
        <Route index={true} element={<MobileProctor />} />
      </Route>
    </>,
  ),
);
